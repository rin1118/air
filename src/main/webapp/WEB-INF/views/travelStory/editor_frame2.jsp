...
<!--
    ...
    -->
<link rel="stylesheet" href="/resources/css/daum/editor.css" type="text/css"
	charset="utf-8" />
<script src="/resources/js/daum/editor_loader.js"
...
<body>
	...
	-->
		<form name="tx_editor_form" id="tx_editor_form"
			action="/travelStory/update" method="post"
			accept-charset="utf-8">
			<!-- 에디터 컨테이너 시작 -->
			<input type="hidden" name="seq" value="${result.seq }">
			<input type="text" name="title" placeholder="제목" value="${result.title }" class="writeInput">
	...
	<div class="btnContainer">
		<button onclick='saveContent()' class="writeBtn">작성</button>
		<button onclick='backBtn()' class="writeBtn">취소</button>
	</div>
