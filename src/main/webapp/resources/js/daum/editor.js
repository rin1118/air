...
(function () {
  ...
  (function () {
    ...
    if (typeof Date.prototype.toJSON !== "function") {
      Date.prototype.toJSON = function () {
        return isFinite(this.valueOf())
          ? this.getUTCFullYear() +
              "-" +
              y(this.getUTCMonth() + 1) +
              "-" +
              y(this.getUTCDate()) +
              "T" +
              y(this.getUTCHours()) +
              ":" +
              y(this.getUTCMinutes()) +
              ":" +
              y(this.getUTCSeconds()) +
              "Z"
          : null;
      };
    ...
    function e(E) {
      ...
      return A.test(E)
        ? '"' +
            E.replace(A, function (F) {
              var G = D[F];
              return typeof G === "string"
                ? G
                : "\\u" + ("0000" + F.charCodeAt(0).toString(16)).slice(-4);
            }) +
            '"'
        : '"' + E + '"';
    }
    ...
    if (typeof JSON.parse !== "function") {
      JSON.parse = function (H, E) {
        ...
        if (
          /^[\],:{}\s]*$/.test(
            H.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@")
              .replace(
  ...
  (function () {
    ...
    Object.extend(t, {
      ...
      gecko: e("firefox"),
      gecko_ver: e("firefox")
        ? parseFloat(x.replace(/.*firefox\/([\d\.]+).*/g, "$1"))
        : 0,
      ...
      msie_ver:
        e("msie") || e("trident")
          ? (function () {
              return e("msie")
                ? parseFloat(x.split("msie")[1])
                : parseFloat(x.split("rv:")[1]);
            })()
          : 0,
      msie_docmode: b.documentMode || 0,
      webkit: e("applewebkit"),
      webkit_ver: e("applewebkit")
        ? parseFloat(x.replace(/.*safari\//g, ""))
        : 0,
      opera: e("opera"),
      presto: e("presto"),
      os_win: e("win"),
      ...
      ios_ver:
        e("like mac os x") && e("mobile")
          ? parseFloat(
              x.replace(/^.*os (\d+)([_\d]*) .*$/g, "$1.$2").replace(/_/g, "")
            )
          : 0,
      android: e("android"),
      android_ver: e("android")
        ? parseFloat(x.replace(/.*android[\s]*([\d\.]+).*/g, "$1"))
        : 0,
    ...
    h.$must = function (B, z) {
      ...
      if (!A) {
        throw new Error(
          "[Exception] " + z + ": cannot find element: id='" + B + "'"
        );
      }
      return A;
    };
  ...
  t.extend(t, {
    getStyle: function (w, x) {
      ...
      var y = w.style[x];
      if (!y) {
        var z = b.defaultView || b.parentWindow;
        var e = z.getComputedStyle(w, i);
        y = e ? e[x] : i;
      }
      if (x == "opacity") {
  ...
  (function () {
    if (t.msie_nonstd) {
      t.getStyle = function (w, x) {
        ...
        if (x == "opacity") {
          if (
            (y = (t.getStyle(w, "filter") || "").match(/alpha\(opacity=(.*)\)/))
          ) {
            if (y[1]) {
    ...
    if (t.msie_nonstd) {
      t.setOpacity = function (w, z) {
        ...
        x.filter =
          y.replace(/alpha\([^\)]*\)/gi, "") + "alpha(opacity=" + z * 100 + ")";
        return w;
      };
    }
    if (t.gecko) {
    ...
    t.extend(t, {
      ...
      pointerX: function (w) {
        ...
        return (
          w.pageX ||
          w.clientX +
            ((y && y.scrollLeft) || (e && e.scrollLeft) || 0) -
            ((y && y.clientLeft) || (e && e.clientLeft) || 0)
        );
      },
      pointerY: function (w) {
        var x = t.element(w).ownerDocument || b;
        ...
        return (
          w.pageY ||
          w.clientY +
            ((y && y.scrollTop) || (e && e.scrollTop) || 0) -
            ((y && y.clientTop) || (e && e.clientTop) || 0)
        );
      },
      stop: function (e) {
        if (e.preventDefault) {
      ...
      findElement: function (x, w) {
        ...
        while (
          ...
          (!e.tagName ||
            ...
            e.tagName.toUpperCase() != w.toUpperCase())
        ) {
          e = e.parentNode;
        }
        return e;
  ...
  (function () {
    ...
    t.extend(String.prototype, {
      ...
      camelize: function () {
        ...
        var x =
          this.charAt(0) == "-"
            ? y[0].charAt(0).toUpperCase() + y[0].substring(1)
            : y[0];
        for (var w = 1; w < e; w++) {
    ...
    t.extend(String.prototype, {
      ...
      toCurrency: function () {
        ...
        for (var e = 0; e < Math.floor((w.length - (1 + e)) / 3); e++) {
          w =
            w.substring(0, w.length - (4 * e + 3)) +
            "," +
            w.substring(w.length - (4 * e + 3));
        }
        return w;
      },
      ...
      toTime: function () {
        return (
          Math.floor(this / 60)
            ...
            .toPaddedString(2) +
          ":" +
          (this % 60).toString().toPaddedString(2)
        );
      },
      toByteUnit: function () {
        var x;
      ...
      if (b.implementation.hasFeature("XPath", "3.0")) {
        ...
        if (typeof Element != q + "") {
          ...
          if (h.origElement) {
            ...
            h.origElement.prototype.selectSingleNode =
      ...
      if (x) {
        ...
        if (
          ...
          (typeof x.length == "number" &&
            typeof x.splice != q + "" &&
            typeof x.propertyIsEnumerable != q + "" &&
  ...
  d.base = function (z, e, B) {
    ...
    if (x.superClass_) {
      return x.superClass_.constructor.apply(
        z,
    ...
    for (
      var y = z.constructor;
      y;
      y = y.superClass_ && y.superClass_.constructor
    ) {
      if (y.prototype[e] === x) {
        A = u;
      } else {
  ...
  d.string.htmlEscape = function (w, e) {
    if (e) {
      return w
        .replace(d.string.amperRe_, "&amp;")
        .replace(d.string.ltRe_, "&lt;")
        .replace(d.string.gtRe_, "&gt;")
        .replace(d.string.quotRe_, "&quot;");
    } else {
  ...
  d.string.compareVersions = function (w, J) {
    ...
    for (var B = 0; x == 0 && B < A; B++) {
      ...
      do {
        ...
        x =
          d.string.compareElements_(C, y) ||
          d.string.compareElements_(H[2].length == 0, G[2].length == 0) ||
          d.string.compareElements_(H[2], G[2]);
      } while (x == 0);
    }
    return x;
  };
  ...
  d.userAgent.BROWSER_KNOWN_ =
    d.userAgent.ASSUME_IE ||
    d.userAgent.ASSUME_GECKO ||
    d.userAgent.ASSUME_MOBILE_WEBKIT ||
    d.userAgent.ASSUME_WEBKIT ||
    d.userAgent.ASSUME_OPERA;
  ...
  d.userAgent.init_ = function () {
    ...
    if (!d.userAgent.BROWSER_KNOWN_ && (w = d.userAgent.getUserAgentString())) {
      ...
      d.userAgent.detectedIe_ =
        !d.userAgent.detectedOpera_ &&
        (d.string.contains(w, "MSIE") || d.string.contains(w, "Trident"));
      d.userAgent.detectedWebkit_ =
        !d.userAgent.detectedOpera_ && d.string.contains(w, "WebKit");
      d.userAgent.detectedMobile_ =
        d.userAgent.detectedWebkit_ && d.string.contains(w, "Mobile");
  ...
  d.userAgent.OPERA = d.userAgent.BROWSER_KNOWN_
    ? d.userAgent.ASSUME_OPERA
    : d.userAgent.detectedOpera_;
  d.userAgent.IE = d.userAgent.BROWSER_KNOWN_
    ? d.userAgent.ASSUME_IE
    : d.userAgent.detectedIe_;
  d.userAgent.GECKO = d.userAgent.BROWSER_KNOWN_
    ? d.userAgent.ASSUME_GECKO
    : d.userAgent.detectedGecko_;
  d.userAgent.WEBKIT = d.userAgent.BROWSER_KNOWN_
    ? d.userAgent.ASSUME_WEBKIT || d.userAgent.ASSUME_MOBILE_WEBKIT
    : d.userAgent.detectedWebkit_;
  d.userAgent.MOBILE =
    d.userAgent.ASSUME_MOBILE_WEBKIT || d.userAgent.detectedMobile_;
  ...
  d.userAgent.PLATFORM_KNOWN_ =
    d.userAgent.ASSUME_MAC ||
    d.userAgent.ASSUME_WINDOWS ||
    d.userAgent.ASSUME_LINUX ||
    d.userAgent.ASSUME_X11;
  d.userAgent.initPlatform_ = function () {
    d.userAgent.detectedMac_ = d.string.contains(d.userAgent.PLATFORM, "Mac");
    d.userAgent.detectedWindows_ = d.string.contains(
      d.userAgent.PLATFORM,
      "Win"
    );
    d.userAgent.detectedLinux_ = d.string.contains(
      d.userAgent.PLATFORM,
      "Linux"
    );
    d.userAgent.detectedX11_ =
      !!d.userAgent.getNavigator() &&
      d.string.contains(d.userAgent.getNavigator()["appVersion"] || "", "X11");
  };
  if (!d.userAgent.PLATFORM_KNOWN_) {
    d.userAgent.initPlatform_();
  }
  d.userAgent.MAC = d.userAgent.PLATFORM_KNOWN_
    ? d.userAgent.ASSUME_MAC
    : d.userAgent.detectedMac_;
  d.userAgent.WINDOWS = d.userAgent.PLATFORM_KNOWN_
    ? d.userAgent.ASSUME_WINDOWS
    : d.userAgent.detectedWindows_;
  d.userAgent.LINUX = d.userAgent.PLATFORM_KNOWN_
    ? d.userAgent.ASSUME_LINUX
    : d.userAgent.detectedLinux_;
  d.userAgent.X11 = d.userAgent.PLATFORM_KNOWN_
    ? d.userAgent.ASSUME_X11
    : d.userAgent.detectedX11_;
  ...
  d.userAgent.isVersionOrHigher = function (e) {
    return (
      d.userAgent.ASSUME_ANY_VERSION ||
      d.userAgent.isVersionOrHigherCache_[e] ||
      (d.userAgent.isVersionOrHigherCache_[e] =
        d.string.compareVersions(d.userAgent.VERSION, e) >= 0)
    );
  };
  ...
  d.userAgent.DOCUMENT_MODE = (function () {
    ...
    return (
      w ||
      (e.compatMode == "CSS1Compat" ? parseInt(d.userAgent.VERSION, 10) : 5)
    );
  })();
  ...
  d.array.indexOf =
    d.NATIVE_ARRAY_PROTOTYPES && d.array.ARRAY_PROTOTYPE_.indexOf
      ? function (e, x, w) {
  ...
  d.array.forEach =
    d.NATIVE_ARRAY_PROTOTYPES && d.array.ARRAY_PROTOTYPE_.forEach
      ? function (e, x, w) {
  ...
  d.array.filter =
    d.NATIVE_ARRAY_PROTOTYPES && d.array.ARRAY_PROTOTYPE_.filter
      ? function (e, x, w) {
  ...
  d.array.map =
    d.NATIVE_ARRAY_PROTOTYPES && d.array.ARRAY_PROTOTYPE_.map
      ? function (e, x, w) {
  ...
  d.array.some =
    d.NATIVE_ARRAY_PROTOTYPES && d.array.ARRAY_PROTOTYPE_.some
      ? function (e, x, w) {
  ...
  d.array.every =
    d.NATIVE_ARRAY_PROTOTYPES && d.array.ARRAY_PROTOTYPE_.every
      ? function (e, x, w) {
  ...
  d.array.concat = function (e) {
    return d.array.ARRAY_PROTOTYPE_.concat.apply(
      d.array.ARRAY_PROTOTYPE_,
      arguments
    );
  };
  ...
  d.array.splice = function (e, w, x, y) {
    return d.array.ARRAY_PROTOTYPE_.splice.apply(
      e,
      d.array.slice(arguments, 1)
    );
  };
  ...
  d.dom.BrowserFeature = {
    CAN_ADD_NAME_OR_TYPE_ATTRIBUTES:
      !d.userAgent.IE || d.userAgent.isVersion("9"),
    CAN_USE_CHILDREN_ATTRIBUTE:
      (!d.userAgent.GECKO && !d.userAgent.IE) ||
      (d.userAgent.IE && d.userAgent.isVersion("9")) ||
      (d.userAgent.GECKO && d.userAgent.isVersion("1.9.1")),
  ...
  d.dom.COMPAT_MODE_KNOWN_ =
    d.dom.ASSUME_QUIRKS_MODE || d.dom.ASSUME_STANDARDS_MODE;
  d.dom.NodeType = {
    ELEMENT: 1,
    ATTRIBUTE: 2,
    TEXT: 3,
  ...
  d.dom.getDomHelper = function (e) {
    return e
      ? new d.dom.DomHelper(d.dom.getOwnerDocument(e))
      : d.dom.defaultDomHelper_ ||
          (d.dom.defaultDomHelper_ = new d.dom.DomHelper());
  };
  d.dom.defaultDomHelper_;
  ...
  d.dom.canUseQuerySelector_ = function (e) {
    return (
      ...
      e.querySelector &&
      (!d.userAgent.WEBKIT ||
        d.dom.isCss1CompatMode_(document) ||
        d.userAgent.isVersion("528"))
    );
  };
  ...
  d.dom.createDom_ = function (z, w) {
    ...
    var e = w[1];
    if (
      !d.dom.BrowserFeature.CAN_ADD_NAME_OR_TYPE_ATTRIBUTES &&
      e &&
      (e.name || e.type)
    ) {
      var B = ["<", y];
  ...
  d.dom.canHaveChildren = function (e) {
    return (
      e.nodeType == d.dom.NodeType.ELEMENT &&
      !d.dom.TAGS_CANT_HAVE_CHILDREN[e.tagName]
    );
  };
  ...
  d.dom.compareNodeOrder = function (C, B) {
    ...
    if ("sourceIndex" in C || (C.parentNode && "sourceIndex" in C.parentNode)) {
      ...
      if (x && e) {
        ...
        return (
          (x ? C.sourceIndex : y.sourceIndex) -
          (e ? B.sourceIndex : w.sourceIndex)
        );
      }
    }
  ...
  d.dom.getOwnerDocument = function (e) {
    return e.nodeType == d.dom.NodeType.DOCUMENT
      ? e
  ...
  d.dom.DomHelper.prototype.$$ =
    d.dom.DomHelper.prototype.getElementsByTagNameAndClass;
  ...
  d.dom.TagIterator.prototype.setPosition = function (w, x, e) {
    ...
    if (w) {
      if (d.isNumber(x)) {
        ...
        this.tagType =
          this.node.nodeType != d.dom.NodeType.ELEMENT
            ? d.dom.TagWalkType.OTHER
            : this.reversed
            ? d.dom.TagWalkType.END_TAG
            : d.dom.TagWalkType.START_TAG;
      }
    }
    if (d.isNumber(e)) {
      this.depth = e;
  ...
  d.dom.SavedCaretRange.CARET_REGEX = /<span\s+id="?goog_\d+"?><\/span>/gi;
  ...
  d.dom.AbstractRange.prototype.getDocument = function () {
    return d.dom.getOwnerDocument(
      d.userAgent.IE ? this.getContainer() : this.getStartNode()
    );
  };
  ...
  d.dom.AbstractRange.prototype.saveUsingCarets = function () {
    return this.getStartNode() && this.getEndNode()
      ? new d.dom.SavedCaretRange(this)
      : i;
  };
  ...
  d.dom.TextRangeIterator = function (x, B, y, C, A) {
    ...
    if (x) {
      ...
      this.endOffset_ = C;
      if (
        x.nodeType == d.dom.NodeType.ELEMENT &&
        x.tagName != d.dom.TagName.BR
      ) {
        var w = x.childNodes;
        var E = w[B];
        if (E) {
  ...
  d.dom.TextRangeIterator.prototype.getStartTextOffset = function () {
    return this.node.nodeType != d.dom.NodeType.TEXT
      ? -1
  ...
  d.dom.TextRangeIterator.prototype.clone = function () {
    var e = new d.dom.TextRangeIterator(
      this.startNode_,
      this.startOffset_,
      this.endNode_,
      this.endOffset_,
  ...
  d.userAgent.jscript.init_ = function () {
    ...
    d.userAgent.jscript.DETECTED_HAS_JSCRIPT_ =
      e && d.global.ScriptEngine() == "JScript";
    d.userAgent.jscript.DETECTED_VERSION_ = d.userAgent.jscript
      .DETECTED_HAS_JSCRIPT_
      ? d.global.ScriptEngineMajorVersion() +
        "." +
        d.global.ScriptEngineMinorVersion() +
        "." +
        d.global.ScriptEngineBuildVersion()
      : "0";
  };
  if (!d.userAgent.jscript.ASSUME_NO_JSCRIPT) {
    d.userAgent.jscript.init_();
  }
  d.userAgent.jscript.HAS_JSCRIPT = d.userAgent.jscript.ASSUME_NO_JSCRIPT
    ? c
    : d.userAgent.jscript.DETECTED_HAS_JSCRIPT_;
  d.userAgent.jscript.VERSION = d.userAgent.jscript.ASSUME_NO_JSCRIPT
    ? "0"
    : d.userAgent.jscript.DETECTED_VERSION_;
  ...
  d.dom.browserrange.AbstractRange.prototype.compareBrowserRangeEndpoints =
    d.abstractMethod;
  d.dom.browserrange.AbstractRange.prototype.containsRange = function (C, A) {
    ...
    try {
      if (y) {
        return (
          this.compareBrowserRangeEndpoints(x, w, B) >= 0 &&
          this.compareBrowserRangeEndpoints(x, B, w) <= 0
        );
      } else {
        return (
          this.compareBrowserRangeEndpoints(x, w, w) >= 0 &&
          this.compareBrowserRangeEndpoints(x, B, B) <= 0
        );
      }
    } catch (z) {
      if (!d.userAgent.IE) {
  ...
  d.dom.browserrange.AbstractRange.prototype.containsNode = function (e, w) {
    return this.containsRange(
      d.dom.browserrange.createRangeFromNodeContents(e),
      w
    );
  };
    ...
    d.iter.forEach(
      ...
      function (z, B, y) {
        if (z.nodeType == d.dom.NodeType.TEXT) {
          e.append(
            d.string.htmlEscape(
              z.nodeValue.substring(
                y.getStartTextOffset(),
                y.getEndTextOffset()
              )
            )
          );
  ...
  d.dom.browserrange.AbstractRange.prototype.__iterator__ = function (e) {
    return new d.dom.TextRangeIterator(
      this.getStartNode(),
      this.getStartOffset(),
      this.getEndNode(),
      this.getEndOffset()
  ...
  d.dom.browserrange.AbstractRange.prototype.surroundContents =
    d.abstractMethod;
  d.dom.browserrange.AbstractRange.prototype.insertNode = d.abstractMethod;
  d.dom.browserrange.AbstractRange.prototype.surroundWithNodes =
    d.abstractMethod;
  ...
  d.dom.browserrange.W3cRange.getBrowserRangeForNode = function (y) {
    ...
    if (y.nodeType == d.dom.NodeType.TEXT) {
      ...
      if (!d.dom.browserrange.canContainRangeEndpoint(y)) {
        ...
        while (
          (z = e.firstChild) &&
          d.dom.browserrange.canContainRangeEndpoint(z)
        ) {
          e = z;
        }
        A.setStart(e, 0);
        ...
        A.setEnd(
          e,
          e.nodeType == d.dom.NodeType.ELEMENT ? e.childNodes.length : e.length
        );
      }
    }
    return A;
  ...
  d.dom.browserrange.W3cRange.createFromNodeContents = function (e) {
    return new d.dom.browserrange.W3cRange(
      d.dom.browserrange.W3cRange.getBrowserRangeForNode(e)
    );
  };
  d.dom.browserrange.W3cRange.createFromNodes = function (y, w, e, x) {
    return new d.dom.browserrange.W3cRange(
      d.dom.browserrange.W3cRange.getBrowserRangeForNodes(y, w, e, x)
    );
  };
  ...
  d.dom.browserrange.W3cRange.prototype.compareBrowserRangeEndpoints = function (
    w,
    x,
    e
  ) {
    return this.range_.compareBoundaryPoints(
      e == d.dom.RangeEndpoint.START
        ? x == d.dom.RangeEndpoint.START
          ? d.global.Range.START_TO_START
          : d.global.Range.START_TO_END
        : x == d.dom.RangeEndpoint.START
        ? d.global.Range.END_TO_START
        : d.global.Range.END_TO_END,
      w
    );
  };
  ...
  d.dom.browserrange.W3cRange.prototype.getValidHtml = function () {
    ...
    var e = y.innerHTML;
    if (
      d.string.startsWith(e, "<") ||
      (!this.isCollapsed() && !d.string.contains(e, "<"))
    ) {
      return e;
    }
  ...
  d.dom.browserrange.WebKitRange.createFromNodeContents = function (e) {
    return new d.dom.browserrange.WebKitRange(
      d.dom.browserrange.W3cRange.getBrowserRangeForNode(e)
    );
  };
  ...
  d.dom.browserrange.WebKitRange.prototype.compareBrowserRangeEndpoints = function (
    w,
    x,
    e
  ) {
    if (d.userAgent.isVersion("528")) {
      return d.dom.browserrange.WebKitRange.superClass_.compareBrowserRangeEndpoints.call(
        this,
        w,
        x,
        e
  ...
  d.dom.browserrange.IeRange.getBrowserRangeForNode_ = function (x) {
    ...
    if (x.nodeType == d.dom.NodeType.ELEMENT) {
      ...
      if (
        d.dom.browserrange.canContainRangeEndpoint(x) &&
        !x.childNodes.length
      ) {
        z.collapse(c);
      }
  ...
  d.dom.browserrange.IeRange.createFromNodeContents = function (x) {
    var w = new d.dom.browserrange.IeRange(
      d.dom.browserrange.IeRange.getBrowserRangeForNode_(x),
      d.dom.getOwnerDocument(x)
    );
    if (!d.dom.browserrange.canContainRangeEndpoint(x)) {
      ...
      while (
        (y = e.firstChild) &&
        d.dom.browserrange.canContainRangeEndpoint(y)
      ) {
        e = y;
      }
      w.startNode_ = e;
  ...
  d.dom.browserrange.IeRange.createFromNodes = function (z, w, e, y) {
    var x = new d.dom.browserrange.IeRange(
      d.dom.browserrange.IeRange.getBrowserRangeForNodes_(z, w, e, y),
      d.dom.getOwnerDocument(z)
    );
    x.startNode_ = z;
    x.startOffset_ = w;
    x.endNode_ = e;
  ...
  d.dom.browserrange.IeRange.prototype.getContainer = function () {
    if (!this.parentNode_) {
      ...
      while (
        w.childNodes.length == 1 &&
        w.firstChild &&
        w.innerText == d.dom.browserrange.IeRange.getNodeText_(w.firstChild)
      ) {
  ...
  d.dom.browserrange.IeRange.prototype.findDeepestContainer_ = function (y) {
    ...
    for (var B = 0, D = F.length; B < D; B++) {
      ...
      if (d.dom.browserrange.canContainRangeEndpoint(w)) {
        ...
        var x = E
          ? this.compareBrowserRangeEndpoints(z, e, e) >= 0 &&
            this.compareBrowserRangeEndpoints(z, e, A) <= 0
          : this.range_.inRange(z);
        if (x) {
  ...
  d.dom.browserrange.IeRange.prototype.compareBrowserRangeEndpoints = function (
    w,
    x,
    e
  ) {
    return this.range_.compareEndPoints(
      (x == d.dom.RangeEndpoint.START ? "Start" : "End") +
        "To" +
        (e == d.dom.RangeEndpoint.START ? "Start" : "End"),
      w
    );
  };
    ...
    for (var F = 0, z = B.childNodes.length; F < z; F++) {
      ...
      if (this.isCollapsed()) {
        ...
        if (this.containsRange(C)) {
          ...
          if (
            this.compareBrowserRangeEndpoints(w, x, E) < 0 &&
            this.compareBrowserRangeEndpoints(w, E, x) > 0
          ) {
  ...
  d.dom.browserrange.IeRange.prototype.compareNodeEndpoints_ = function (
    x,
    w,
    e
  ) {
    return this.range_.compareEndPoints(
      (w == d.dom.RangeEndpoint.START ? "Start" : "End") +
        "To" +
        (e == d.dom.RangeEndpoint.START ? "Start" : "End"),
      d.dom.browserrange.createRangeFromNodeContents(x).getBrowserRange()
    );
  };
    ...
    if (this.range_.htmlText) {
      ...
      try {
        ...
        if (
          x == A &&
          x.parentNode &&
          x.nodeType == d.dom.NodeType.TEXT &&
          E &&
          E.nodeType == d.dom.NodeType.TEXT
        ) {
  ...
  d.dom.browserrange.IeRange.prototype.insertNode = function (w, x) {
    var e = d.dom.browserrange.IeRange.insertNode_(
  ...
  d.dom.browserrange.GeckoRange.createFromNodeContents = function (e) {
    return new d.dom.browserrange.GeckoRange(
      d.dom.browserrange.W3cRange.getBrowserRangeForNode(e)
    );
  };
  ...
  d.dom.browserrange.OperaRange.createFromNodeContents = function (e) {
    return new d.dom.browserrange.OperaRange(
      d.dom.browserrange.W3cRange.getBrowserRangeForNode(e)
    );
  };
  ...
  d.dom.browserrange.createRange = function (e) {
    if (d.userAgent.IE && !d.userAgent.isDocumentMode(9)) {
      return new d.dom.browserrange.IeRange(
        e,
        d.dom.getOwnerDocument(e.parentElement())
      );
    } else {
      if (d.userAgent.WEBKIT) {
  ...
  d.dom.TextRange.createFromBrowserRange = function (e, w) {
    return d.dom.TextRange.createFromBrowserRangeWrapper_(
      d.dom.browserrange.createRange(e),
      w
    );
  };
  ...
  d.dom.TextRange.createFromNodeContents = function (w, e) {
    return d.dom.TextRange.createFromBrowserRangeWrapper_(
      d.dom.browserrange.createRangeFromNodeContents(w),
      e
    );
  };
  ...
  d.dom.TextRange.prototype.getBrowserRangeWrapper_ = function () {
    return (
      ...
      (this.browserRangeWrapper_ = d.dom.browserrange.createRangeFromNodes(
        this.getStartNode(),
        this.getStartOffset(),
        this.getEndNode(),
        this.getEndOffset()
  ...
  d.dom.TextRange.prototype.isRangeInDocument = function () {
    return (
      (!this.startNode_ || d.dom.TextRange.isAttachedNode(this.startNode_)) &&
      (!this.endNode_ || d.dom.TextRange.isAttachedNode(this.endNode_)) &&
      (!(d.userAgent.IE && !d.userAgent.isDocumentMode(9)) ||
  ...
  d.dom.DomSavedTextRange_.prototype.restoreInternal = function () {
    return d.dom.Range.createFromNodes(
      this.anchorNode_,
      this.anchorOffset_,
      this.focusNode_,
      this.focusOffset_
  ...
  d.dom.MultiRange.prototype.getTextRange = function (e) {
    if (!this.ranges_[e]) {
      this.ranges_[e] = d.dom.TextRange.createFromBrowserRange(
        this.browserRanges_[e]
      );
    }
  ...
  d.dom.ControlRange.prototype.clone = function () {
    return d.dom.ControlRange.createFromElements.apply(
      this,
      this.getElements()
    );
  };
  ...
  d.dom.ControlRange.prototype.isRangeInDocument = function () {
    ...
    try {
      w = this.getElements().every(function (e) {
        return d.userAgent.IE
          ? e.parentNode
          : d.dom.contains(e.ownerDocument.body, e);
      });
    } catch (x) {}
    return w;
  };
  ...
  d.dom.ControlRange.prototype.getPastableHtml =
    d.dom.ControlRange.prototype.getValidHtml;
  ...
  d.dom.DomSavedControlRange_.prototype.restoreInternal = function () {
    var y = this.elements_.length
      ? d.dom.getOwnerDocument(this.elements_[0])
      : document;
  ...
  d.dom.Range.createFromBrowserRange = function (e, w) {
    return d.dom.AbstractRange.isNativeControlRange(e)
      ? d.dom.ControlRange.createFromBrowserRange(e)
      : d.dom.TextRange.createFromBrowserRange(e, w);
  };
  ...
  h.installHyperscript = function (w, e) {
    a(
      "a big blockquote br b center code dd dl dt div em font form h1 h2 h3 h4 h5 h6 hr img iframe input i li ol option pre p script select small span strike strong style sub sup table tbody td textarea tr ul u".split(
        " "
      ),
      function (x) {
        w[x] = function () {
                    ...
                    if (z == "style") {
                      for (var B in A[z]) {
                        if (B == "float" || B == "cssFloat") {
                          y[z][
                            y[z].styleFloat === q ? "cssFloat" : "styleFloat"
                          ] = A[z][B];
                        } else {
                          y[z][B] = A[z][B];
                        }
  ...
  (function (w) {
    ...
    w.Mixin = w.Faculty = {
      ...
      toClass: function (y, z) {
        return w.Class.create(
          Object.extend({ initialize: z ? z : function () {} }, y)
        );
      },
    };
  })(g);
  ...
  g.__CONFIG_COMMON = {
    ...
    textbox: {
      options: [
        m("txc-textbox1", "10px", "#ffffff", "1px solid #f7f7f7"),
        m("txc-textbox2", "10px", "#eeeeee", "1px solid #eeeeee"),
        m("txc-textbox3", "10px", "#fefeb8", "1px solid #fefeb8"),
        m("txc-textbox4", "10px", "#fedec7", "1px solid #fedec7"),
        m("txc-textbox5", "10px", "#e7fdb5", "1px solid #e7fdb5"),
        m("txc-textbox6", "10px", "#dbe8fb", "1px solid #dbe8fb"),
        m("txc-textbox7", "10px", "#ffffff", "1px dashed #cbcbcb"),
        m("txc-textbox8", "10px", "#eeeeee", "1px dashed #c1c1c1"),
        m("txc-textbox9", "10px", "#fefeb8", "1px dashed #f3c534"),
        m("txc-textbox10", "10px", "#fedec7", "1px dashed #fe8943"),
        m("txc-textbox11", "10px", "#e7fdb5", "1px dashed #9fd331"),
        m("txc-textbox12", "10px", "#dbe8fb", "1px dashed #79a5e4"),
        m("txc-textbox13", "10px", "#ffffff", "1px solid #cbcbcb"),
        m("txc-textbox14", "10px", "#eeeeee", "1px solid #c1c1c1"),
        m("txc-textbox15", "10px", "#fefeb8", "1px solid #f3c534"),
        m("txc-textbox16", "10px", "#fedec7", "1px solid #fe8943"),
        m("txc-textbox17", "10px", "#e7fdb5", "1px solid #9fd331"),
        m("txc-textbox18", "10px", "#dbe8fb", "1px solid #79a5e4"),
        m("txc-textbox19", "10px", "#ffffff", "3px double #cbcbcb"),
        m("txc-textbox20", "10px", "#eeeeee", "3px double #c1c1c1"),
        m("txc-textbox21", "10px", "#fefeb8", "3px double #f3c534"),
        m("txc-textbox22", "10px", "#fedec7", "3px double #fe8943"),
        m("txc-textbox23", "10px", "#e7fdb5", "3px double #9fd331"),
        m("txc-textbox24", "10px", "#dbe8fb", "3px double #79a5e4"),
      ],
    },
  };
  var p = (function () {
    ...
    var x = {
      getUrl: function (J, K) {
        ...
        var G =
          h.EditorJSLoader ||
          (opener && opener.EditorJSLoader) ||
          (PopupUtil && PopupUtil.getOpener()["EditorJSLoader"]);
  ...
  Object.extend(v, {
    removeListIfEmpty: function (e) {
      while (
        ...
        v.kindOf(e.firstChild, "%listhead")
      ) {
        e = e.firstChild;
      }
    ...
    Object.extend(v, {
      ...
      setStyles: function (z, F, C) {
        ...
        for (var A in H) {
          ...
          E =
            (!z.style[A] &&
              (A.indexOf("font") != 0 || D.indexOf("font:") == -1)) ||
            C;
  ...
  Object.extend(v, {
    ...
    getScrollTop: function (w) {
      ...
      var e = this.getWindow(w);
      var x = "pageYOffset";
      return x in e ? e[x] : w.documentElement.scrollTop;
    },
  ...
  Object.extend(v, {
    EMPTY_BOGUS:
      t.msie_quirks || (t.msie && t.msie_ver < 11) ? "&nbsp;" : "<br>",
  });
  ...
  (function (e) {
    e.Util = {
      ...
      getAllAttributesFromEmbed: function (y) {
        var B = {};
        y = y.replace(/<embed|>/gi, "");
        try {
          var A = /(\w+)=((?:\")[^\"]+(?:\"|$)|(?:')[^']+(?:'|$)|(?:[^\"'][^ \n]+($| |\n)))/gi;
          var x;
          while ((x = A.exec(y)) != i) {
            B[x[1].trim().toLowerCase()] = x[2]
              .replace(/^(\"|')/i, "")
              .replace(/(\"|')$/i, "")
              .trim();
          }
      ...
      getAllAttributes: function (z) {
        var A = {};
        var x;
        var y = /style="(?:\s*|(?:[^"]*(?:;\s*)))width\s*:\s*([0-9]+)px[^"]*"/gi;
        while ((x = y.exec(z)) != i) {
          A.width = x[1];
        }
        y = /style="(?:\s*|(?:[^"]*(?:;\s*)))height\s*:\s*([0-9]+)px[^"]*"/gi;
        while ((x = y.exec(z)) != i) {
          A.height = x[1];
        }
          ...
          for (var x = 0; x < B; x++) {
            if (E * B + x < D) {
              ...
              if (A.image) {
                ...
                y.push(
                  '<td class="tx-menu-list-item"><a href="javascript:;"><span class="' +
                    (A.klass || "") +
                    '"><img src="' +
                    C +
                    '" data="' +
              ...
              y.push(
                '<td class="tx-menu-list-item"><a href="javascript:;"><span class="">&nbsp;</span></a></td>'
              );
            }
          }
          y.push("</tr>");
    ...
    e.Validator = e.Class.create({
      ...
      strip: function (x) {
        return x
          .stripTags()
          .replace(/&nbsp;/g, "")
          .replace(e.__WORD_JOINER_REGEXP, "")
          .trim();
      },
      exists: function (x) {
        if (!x) {
        ...
        if (this.strip(x) == "") {
          if (
            x.search(/<(img|iframe|object|embed|table|hr|script|TXDB)/i) < 0
          ) {
            return c;
          }
        }
    ...
    e.Paging = e.Class.create({
      $const: { DEFAULT_PAGE_SIZE: 5, DEFAULT_BLOCK_SIZE: 10 },
    ...
    e.Slidebar = e.Class.create({
      initialize: function (x) {
        ...
        this.physicObj.interval =
          (this.logicObj.interval * this.physicObj.max) / this.logicObj.max;
        this.startPos = 0;
        this.startX = 0;
        this.isDrag = c;
        this.result = 0;
      ...
      setKnobPosition: function (x) {
        ...
        this.result = Math.round(
          (x * this.logicObj.interval) / this.physicObj.interval
        );
      },
      setDisable: function () {
        this.isDisabled = u;
    ...
    fireElements: function (z) {
      ...
      try {
        ...
        if (v.kindOf(y, "img,hr,table,button,iframe")) {
          B = this.collectObserverByElement(
  ...
  g.I.ColorPallete = g.Faculty.create({
    ...
    hookEvent: function (x) {
      ...
      if (x.needRevert) {
        v.insertFirst(
          w,
          g.MarkupTemplate.get("menu.colorpallete.revert").evaluateAsDom({})
        );
        t.observe(
          v.collect(w, "p.tx-pallete-revert a"),
          "click",
          function (L) {
            this.onSelect(L, i);
            this.hide();
    ...
    addColorClickEvent: function (A, w) {
      for (var y = 0, e = A.length; y < e; y++) {
        ...
        t.observe(
          x,
          "click",
          this.onSelect.bindAsEventListener(
            this,
            z.color + (z.text ? "|" + z.text : "")
          )
        );
      }
    },
    ...
    hex2rgb: function (e) {
      this.mRGB.r =
        this.toDec(e.substr(0, 1)) * 16 + this.toDec(e.substr(1, 1));
      this.mRGB.g =
        this.toDec(e.substr(2, 1)) * 16 + this.toDec(e.substr(3, 1));
      this.mRGB.b =
        this.toDec(e.substr(4, 1)) * 16 + this.toDec(e.substr(5, 1));
      return this.mRGB;
    },
    toDec: function (w) {
  ...
  g.Color = {
    getHexColor: function (w) {
      ...
      if (w.indexOf("rgb") < 0) {
        if (
          w.length > 0 &&
          (w.indexOf("-moz-use") > -1 || w == "transparent")
        ) {
          return "transparent";
        } else {
          return w;
    ...
    getOptColor: function (w, x) {
      ...
      for (var z = 0; z < 3; z++) {
        ...
        e = Math.round(
          Math.floor((255 - A) * (1 - x * 0.01) + A * (x * 0.02))
        ).toString(16);
        if (e.length == 1) {
          y += "0" + e;
        } else {
  ...
  g.MarkupTemplate.add(
    "button.itsnew",
    '<em class="tx-itsnew" title="new">new</em>'
  );
  ...
  g.Button = g.Class.create({
    ...
    initialize: function (e) {
      ...
      if (!x) {
        throw new Error(
          "[Exception]Trex.Button : can't find elIcon for button '" + w + "'"
        );
      }
    ...
    ongenerated: function () {
      ...
      if (e) {
        ...
        t.observe(
          e,
          "mouseover",
          this.onArrowMouseOver.bindAsEventListener(this)
        );
        t.observe(
          e,
          "mouseout",
          this.onArrowMouseOut.bindAsEventListener(this)
        );
  ...
  g.Button.Splits = g.Class.create({
    ...
    ongenerated: function () {
      ...
      if (!e) {
        throw new Error(
          "[Exception]Trex.Button.Splits : not exist element(a.tx-arrow)"
        );
      }
      t.observe(
        e,
        "mousedown",
        this.onArrowMouseDown.bindAsEventListener(this)
      );
      t.observe(
        e,
        "mouseover",
  ...
  g.Menu = g.Class.create({
    ...
    initialize: function (e) {
      ...
      if (x.el) {
        ...
        if (!y) {
          throw new Error(
            "[Exception]Trex.Menu : not exist element(" + x.el + ")"
          );
        }
      } else {
        var w = x.id;
        ...
        if (!y) {
          throw new Error(
            "[Exception]Trex.Menu : not exist element(" + w + ")"
          );
        }
      }
      this.elMenu = y;
    ...
    generateList: function (z) {
      ...
      for (var e = 0; e < z.length; e++) {
        ...
        t.observe(
          x,
          "click",
          this.onSelect.bindAsEventListener(this, A.data, A.title)
        );
      }
      return w;
    },
  ...
  g.Menu.List = g.Class.create({
    ...
    onSelect: function (w) {
      ...
      if (x.tagName && x.tagName.toLowerCase() == "span") {
        ...
        if (
          x.firstChild &&
          x.firstChild.nodeType == 1 &&
          x.firstChild.tagName.toLowerCase() == "img"
        ) {
  ...
  g.Menu.Matrix = g.Class.create({
    ...
    generateMatrix: function (E) {
      ...
      var B = v.collectAll(
        C,
        "div.tx-menu-matrix-listset div.tx-menu-matrix-list"
      );
  ...
  g.Menu.ColorPallete = g.Class.create({
    ...
    generate: function () {
      ...
      if (!this.hookEvent) {
        throw new Error(
          "[Exception]Trex.Menu.ColorPallete : not implement function(hookEvent)"
        );
      }
      this.hookEvent(w);
      if (this.generateHandler) {
  ...
  t.msie &&
    g.module("add menu layer shield for IE flash object", function (
      y,
      A,
      B,
      x
  ...
  g.Editor = g.Class.create({
    ...
    initialize: function (x) {
      ...
      A.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
        ...
        if (A.mode != g.Canvas.__WYSIWYG_MODE) {
          A.fireJobs(
            g.Ev.__CANVAS_MODE_INITIALIZE,
            g.Canvas.__WYSIWYG_MODE,
            A.mode
          );
        }
        t.hide(E);
    ...
    getAutosaveSeq: function () {
      return this.getAutoSaver && this.getAutoSaver()
        ? this.getAutoSaver().getCurSeq()
        : "0";
    },
  });
  (function () {
  ...
  g.Tool = g.Class.draft({
    ...
    initialize: function (w, x, e) {
      if (!this.constructor.__Identity) {
        throw new Error(
          "[Exception]Trex.Tool : not implement const(__Identity)"
        );
      }
    ...
    oninitialized: function () {
      throw new Error(
        "[Exception]Trex.Tool : not implements function(oninitialized)"
      );
    },
  ...
  g.AsyncTool = g.Class.draft({
    ...
    oninitialized: function () {
      this.loaded = false;
      throw new Error(
        "[Exception]Trex.AsyncTool : not implements function(oninitialized)"
      );
    },
  ...
  g.Sidebar = g.Class.create({
    ...
    initialize: function (e) {
      ...
      w.observeJob(
        g.Ev.__CANVAS_PANEL_DELETE_SOMETHING,
        function () {
          this.syncSidebar();
        }.bind(this)
      );
  ...
  g.EntryBox = g.Class.draft({
    ...
    initialize: function () {
      throw new Error(
        "[Exception]Trex.EntryBox : not implements function(initialize)"
      );
    },
    newSeq: function () {
      return ++this.autoSeq;
  ...
  g.Entry = g.Class.draft({
    ...
    initialize: function () {
      throw new Error(
        "[Exception]Trex.Entry : not implements function(initialize)"
      );
    },
    ...
    getChangedContentFromHtml: function (e) {
      return this.getChangedContent(e, this.regHtml, this.dispText, [
        "id",
        "class",
      ]);
    },
    ...
    getChangedContentAtSave: function (e) {
      return this.getChangedContent(e, this.regHtml, this.saveHtml, [
        "id",
        "class",
      ]);
    },
  ...
  g.Actor = g.Class.draft({
    ...
    initialize: function () {
      throw new Error(
        "[Exception]Trex.Actor : not implements function(initialize)"
      );
    },
    execAttach: function (x, w) {
      var e = this.createEntry(this.getDataForEntry(x), w);
      e.execRegister();
      this.canvas.fireJobs(
        "canvas." + (w || this.constructor.__Identity) + ".added",
        e
      );
    },
  ...
  g.FormProxy = g.Class.create({
    ...
    getFormField: function () {
      ...
      for (var x = 0; x < y.length; x++) {
        e = y[x];
        if (
          !["select", "input", "textarea"].contains(e.tagName.toLowerCase())
        ) {
          continue;
        }
        if (!e.name && !e.id) {
    ...
    setFormField: function (e) {
      ...
      for (var z = 0; z < A.length; z++) {
        y = A[z];
        if (
          !["select", "input", "textarea"].contains(y.tagName.toLowerCase())
        ) {
          continue;
        }
  ...
  g.install(
    "editor.getSaver & editor.getDataAsJSON & editor.setDataByJSON",
    function (x, y, z, w, e) {
  ...
  g.Save = g.Class.create({
    ...
    load: function (w) {
      w = {
        inputmode:
          !w.inputmode || w.inputmode == "html" ? "original" : w.inputmode,
        content: (function () {
          var y = w.content;
          if (typeof y == "string") {
            return w.content;
          } else {
            if (y && y.nodeType && y.nodeType == 1) {
      ...
      this.editor.fireJobs(g.Ev.__EDITOR_LOAD_DATA_BEGIN, w);
      if (!w) {
    ...
    makeField: function () {
      ...
      x.createField(
        tx.textarea({ name: "tx_content", style: { display: "none" } }, e)
      );
      var w = y.getFields();
      w.each(function (z) {
        x.createField(
          tx.input({ type: "hidden", name: z.name, value: z.value })
        );
      });
    },
  });
    ...
    initialize: function (x, e) {
      ...
      this.dragingAtDocument = function (D) {
        ...
        if (this.isDragging) {
          ...
          try {
            var C = Math.max(
              this.panelHeight + D.clientY - this.dragStartPosY,
              this.minDragHeight.parsePx()
            ).toPx();
            E.setPanelHeight(C);
            A = C;
      ...
      this.documentDraggingHandler = this.dragingAtDocument.bindAsEventListener(
        this
      );
      this.wysiwygDraggingHandler = this.dragingAtWysiwyg.bindAsEventListener(
        this
      );
      this.isDragging = c;
  ...
  (function () {
    ...
    g.History = g.Class.create({
      $mixins: [
        g.I.History.Standard,
        t.msie_nonstd ? g.I.History.Trident : g.I.History.Webkit,
      ],
      maxUndoCount: x,
      canvas: i,
      undoMementoList: i,
      ...
      initHistory: function (B) {
        ...
        var A = new w();
        var y = Object.extend(
          { content: v.EMPTY_PARAGRAPH_HTML, scrollTop: 0 },
          B
        );
        A.addUndoData(y);
      ...
      saveHistoryByKeyEvent: function (A) {
        ...
        var y = this;
        if (
          z.code == g.__KEY.ENTER ||
          z.code == g.__KEY.SPACE ||
          z.code == g.__KEY.TAB
        ) {
          y.saveHistoryIfEdited();
        } else {
  ...
  (function (w) {
    ...
    p.add(
      ...
      function (z) {
        ...
        B.wysiwygUrl = p.getUrl(
          [
            B.wysiwygPath || "#host#path/pages/daumx/",
            "wysiwyg_",
            B.serviceWysiwyg || "",
            B.doctype == "html" ? "html" : "xhtml",
            ".",
            B.ext ? B.ext : "html",
            "?prefix=" + z.initializedId,
            "&",
            B.param,
          ].join("")
        );
    ...
    w.Canvas = w.Class.create({
      ...
      $mixins: [
        w.I.JobObservable,
        w.I.KeyObservable,
        w.I.ElementObservable,
        w.I.MouseoverObservable,
      ],
      editor: i,
      elContainer: i,
      config: i,
      ...
      changeMode: function (z) {
        ...
        try {
          if (
            z == "html" &&
            !this.getPanel("html").designModeActivated &&
            t.gecko
          ) {
      ...
      setCanvasSize: function (y) {
        if (this.panels[this.mode] && y.height) {
          ...
          throw new Error(
            "[Exception]Trex.Canvas : argument has no property - size.height "
          );
        }
      },
      canHTML: function () {
      ...
      initContent: function (y) {
        ...
        this.includeWebfontCss(y);
        this.fireJobs(
          w.Ev.__CANVAS_DATA_INITIALIZE,
          w.Canvas.__WYSIWYG_MODE,
          i
        );
      },
      ...
      onKeyDown: function (A) {
        ...
        function D() {
          var E = d.dom.Range.createFromBrowserSelection(
            B.getSelection ? B.getSelection() : C.getSel()
          );
        ...
        var z = null;
        if (
          A.keyCode == w.__KEY.BACKSPACE &&
          C.isCollapsed() &&
          (z = v.prevNodeUntilTagName(y.node, y.offset, "table")) &&
          v.isTagName(z, "table")
        ) {
          t.stop(A);
      ...
      onMouseMove: function (y) {
        try {
          this.fireJobs(w.Ev.__CANVAS_PANEL_MOUSEMOVE, y);
        } catch (z) {}
      },
  ...
  g.module("bind canvas events for close external menus", function (
    x,
    y,
    z,
    w
  ...
  g.module("make getter for 'iframeheight' and 'iframetop' size", function (
    y,
    A,
    B,
    x
  ...
  g.module(
    "synchronize the font style when caret is in end of paragraph",
    function (w, x, y, e) {
      t.gecko &&
        e.observeJob(g.Ev.__CANVAS_PANEL_MOUSEUP, function (I) {
          if (e.isWYSIWYG()) {
            var C = I.target;
  ...
  g.module("apply respectVisibilityInDesign for old IE", function (
    x,
    z,
    A,
    w,
    ...
    C &&
      w.observeJob(g.Ev.__CANVAS_MODE_CHANGE, function (D, E) {
        y();
      });
    C &&
      w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function (D) {
        y();
      });
  ...
  g.Canvas.BasedPanel = g.Class.draft({
    initialize: function (x, w) {
      ...
      if (!this.el) {
        throw new Error(
          "[Exception]Trex.Canvas.Panel : panel element is not founded"
        );
      }
  ...
  (function () {
    ...
    var e =
      '<html lang="ko"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>DaumEditor Wygiwyg Panel</title><script id="txScriptForEval"></script><link rel="stylesheet" href="' +
      w +
      'content_view.css" type="text/css"></link><link rel="stylesheet" href="' +
      w +
      'content_wysiwyg.css" type="text/css"></link><style id="txStyleForSetRule"></style></head><body class="tx-content-container">' +
      v.EMPTY_PARAGRAPH_HTML +
      "</body></html>";
  })();
  (function () {
  ...
  (function () {
    g.Canvas.WysiwygPanel = g.Class.create({
      ...
      initialize: function (A, B) {
        ...
        var z = this;
        var C = new g.WysiwygIframeLoader(
          this.iframe,
          B.wysiwygCatalystUrl,
          B.doctype
        );
        C.load(function (F) {
          z.wysiwygDoc = F;
      ...
      bindEvents: function (z) {
        var A = new g.WysiwygEventBinder(
          this.wysiwygWindow,
          this.wysiwygDoc,
          z,
          this.processor
      ...
      setHeightBody: function (A) {
        var z = this.wysiwygWindow.document.body;
        var B =
          parseInt(t.getStyle(z, "margin-top")) +
          parseInt(t.getStyle(z, "padding-top"));
        var C =
          parseInt(t.getStyle(z, "margin-bottom")) +
          parseInt(t.getStyle(z, "padding-bottom"));
        A = parseInt(A) - B - C;
        z.style.height = A.toPx();
        this._bodyHeight = A;
      },
      ...
      getHolder: function (z) {
        var A = z.initializedId || "";
        return $must(
          "tx_canvas_wysiwyg_holder" + A,
          "Trex.Canvas.WysiwygPanel"
        );
      },
      focus: function () {
  ...
  g.module("canvas set focus on mousedown event. only IE.", function (
    x,
    y,
    z,
    w,
  ...
  g.module("auto body resize", function (x, y, z, w, e) {
    w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
      var D = "";
      var C = 0;
      var B = w.getPanel("html");
      C = B._bodyHeight;
      w.observeJob("canvas.height.change", function (E) {
        C = parseInt(B._bodyHeight);
      });
      function A() {
        if (!w.isWYSIWYG()) {
          return;
        ...
        D = E;
        G.style.height = "";
        var F = t.getDimensions(G).height;
        B._bodyContentHeight = F;
        if (F < C) {
          G.style.height = C.toPx();
        }
      }
      setInterval(A, 200);
    });
  ...
  g.Canvas.HtmlPanel = g.Class.create({
    ...
    $const: { __MODE: g.Canvas.__HTML_MODE },
    initialize: function (w, e) {
      this.$super.initialize(w, e);
      this.bindEvents();
      if (t.msie_ver == "8") {
        this.el.setAttribute(
          "style",
          "width: 500px; min-width: 100%; max-width: 100%;"
        );
      }
  ...
  g.Canvas.TextPanel = g.Class.create({
    $extend: g.Canvas.TextareaPanel,
    $const: { __MODE: g.Canvas.__TEXT_MODE },
    initialize: function (w, e) {
      this.$super.initialize(w, e);
      this.bindEvents();
    },
  ...
  g.Canvas.Selection = g.Class.create({
    $mixins: [
      g.I.Selection.Standard,
      t.msie_nonstd ? g.I.Selection.Trident : {},
      t.msie_std ? g.I.Selection.TridentStandard : {},
      t.gecko ? g.I.Selection.Gecko : {},
      t.webkit ? g.I.Selection.Webkit : {},
      t.presto ? g.I.Selection.Presto : {},
    ],
    initialize: function (e) {
      this.processor = e;
      this.win = e.win;
      ...
      if (x.style && x.style[w]) {
        ...
        if (x.currentStyle && x.currentStyle[w]) {
          ...
          if (h.getComputedStyle) {
            ...
            var y = v.getWindow(this.doc);
            var e = y.getComputedStyle(z, i);
            return e ? e[w] : i;
          }
        }
      }
      ...
      if (z) {
        ...
        this.execWithMarker(function (E) {
          ...
          if (A.length == 1) {
            ...
            var H = v.kindOf(
              F,
              "table,hr,blockquote,pre,h1,h2,h3,h4,h5,h6,div"
            );
  ...
  g.module("observe that @when control elements are focused at", function (
    w,
    x,
    y,
    e
  ...
  g.module("delete image element @when backspace key event fires", function (
    w,
    x,
    y,
    e
    ...
    if (t.msie_nonstd) {
      e.observeKey(
        { ctrlKey: c, altKey: c, shiftKey: c, keyCode: g.__KEY.BACKSPACE },
        function () {
          var A = e.getProcessor();
  ...
  g.I.Processor.TridentStandard = {
    ...
    controlEnterByLinebreak: function (y) {
      ...
      if (
        ...
        if (
          A.tagName == "BLOCKQUOTE" ||
          t.hasClassName(A, "txc-textbox") ||
          t.hasClassName(A, "txc-moreless")
        ) {
          t.stop(y);
          var e = x.win.br();
          w.insertNode(e);
    ...
    addDummyNbsp: function (e) {
      ...
      if (e.length === 1) {
        w = e[0];
        if (
          w.tagName.toLowerCase() === "span" &&
          w.childNodes.length === 1 &&
          w.firstChild.nodeType === 3 &&
          w.firstChild.data === ""
        ) {
          w.firstChild.data = "\u00A0";
        }
  ...
  g.module("put bogus paragraph @when any key event fires", function (
    w,
    x,
    y,
    e
  ...
  g.module("interrupt enter key action @ wysiwyg panel", function (w, x, z, e) {
    ...
    e.observeKey(
      { ctrlKey: c, altKey: c, shiftKey: c, keyCode: g.__KEY.ENTER },
      function (B) {
        if (!e.isWYSIWYG()) {
          return;
        }
  ...
  g.Canvas.Processor = g.Class.draft({
    $mixins: [
      g.I.Processor.Standard,
      t.msie_nonstd ? g.I.Processor.Trident : {},
      t.msie_std ? g.I.Processor.TridentStandard : {},
      t.gecko ? g.I.Processor.Gecko : {},
      t.webkit ? g.I.Processor.Webkit : {},
      t.presto ? g.I.Processor.Presto : {},
    ],
  });
  g.Canvas.ProcessorP = g.Class.create({
    ...
    $mixins: [
      g.I.Processor.StandardP,
      t.msie_nonstd ? g.I.Processor.TridentP : {},
      t.msie_std ? g.I.Processor.TridentStandardP : {},
      t.gecko ? g.I.Processor.GeckoP : {},
      t.webkit ? g.I.Processor.WebkitP : {},
      t.presto ? g.I.Processor.PrestoP : {},
    ],
  });
  ...
  j.addMsg({
    "@attacher.only.wysiwyg.alert":
      "\uc5d0\ub514\ud130 \uc0c1\ud0dc\uc5d0\uc11c\ub9cc \ubcf8\ubb38\uc5d0 \uc0bd\uc785\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4.\n\uc5d0\ub514\ud130\ubaa8\ub4dc\uc5d0\uc11c \ucca8\ubd80\ubc15\uc2a4\uc758 \uc378\ub124\uc77c\uc744 \ud074\ub9ad\ud574\uc11c \uc0bd\uc785\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4.",
  });
  g.Attachment = g.Class.draft({
    ...
    register: function () {
      ...
      if (this.canvas.isWYSIWYG()) {
        ...
        if (this.objectStyle) {
          ...
          B = B.replace(
            C,
            "<" + y + ' style="' + g.Util.toStyleString(this.objectStyle) + '" '
          );
        }
        if (this.objectAttr) {
          B = B.replace(
            C,
            "<" + y + " " + g.Util.toAttrString(this.objectAttr) + " "
          );
        }
    ...
    getParaStyle: function (e) {
      var w = Object.extend(
        {},
        this.actor.config.parastyle || this.actor.config.defaultstyle
      );
      return w;
    },
  ...
  g.install("editor.getAttachBox & sidebar.getAttachments", function (
    y,
    z,
    A,
    x,
  ...
  j.addMsg({
    ...
    "@attacher.delete.confirm":
      "\uc0ad\uc81c\ud558\uc2dc\uba74 \ubcf8\ubb38\uc5d0\uc11c\ub3c4 \uc0ad\uc81c\ub429\ub2c8\ub2e4. \uacc4\uc18d\ud558\uc2dc\uaca0\uc2b5\ub2c8\uae4c?",
    "@attacher.delete.all.confirm":
      "\ubaa8\ub4e0 \ucca8\ubd80 \ud30c\uc77c\uc744 \uc0ad\uc81c\ud558\uc2dc\uaca0\uc2b5\ub2c8\uae4c? \uc0ad\uc81c\ud558\uc2dc\uba74 \ubcf8\ubb38\uc5d0\uc11c\ub3c4 \uc0ad\uc81c\ub429\ub2c8\ub2e4.",
    "@attacher.exist.alert":
      "\uc774\ubbf8 \ubcf8\ubb38\uc5d0 \uc0bd\uc785\ub418\uc5b4 \uc788\uc2b5\ub2c8\ub2e4.",
  });
  g.install(
    "attachbox.onAttachBoxInitialized @if config.sidebar.attachbox.show = true",
    function (y, z, A, x, w) {
  ...
  g.I.AttachBox = {
    ...
    registerEntryNode: function (y) {
      ...
      A.appendChild(z);
      var w = tx.dt(
        { className: "tx-name", unselectable: "on" },
        y.boxAttr.name
      );
      y.elName = w;
      z.appendChild(w);
    ...
    refreshPreview: function () {
      for (var w = 0, e = this.datalist.length - 1; w < e; ++w) {
        ...
        if (
          ...
          this.lastSelectedEntry.key == x.key &&
          x.deleteMark == false
        ) {
    ...
    doUpload: function (w) {
      var e = 300;
      this.elProgressPercent.style.width = Math.floor(
        e * (isNaN(w) ? 0 : parseFloat(w) * 0.01)
      ).toPx();
      this.elProgressTicker.innerText =
        Math.floor(isNaN(w) ? 0 : parseFloat(w)) + "%";
    },
    endUpload: function () {
    ...
    clickEntry: function (e) {
      ...
      this.elPreviewKind.className = e.boxAttr.className
        ? e.boxAttr.className
        : "";
      e.makeSelection(u);
    ...
    clickEntryWithShift: function (x) {
      if (t.hasClassName(x.elData, "tx-clicked")) {
        ...
        this.elPreviewKind.className = x.boxAttr.className
          ? x.boxAttr.className
          : "";
        for (var w = A; w < z + 1; w++) {
  ...
  g.install(
    "attachbox.onFileCapacityInitialized @if sidebar.capacity.show = true",
    function (y, z, A, x, w) {
      var e = y.getAttachBox();
  ...
  g.module("attachbox.updateCapacity on Trex.Ev.__ATTACHBOX_SHOW", function (
    w
  ) {
  ...
  g.I.FileCapacity = {
    onFileCapacityInitialized: function (y, x) {
      ...
      this.checkInsertableSize = function (G) {
        return (
          parseInt(A.uploaded, 10) + parseInt(G, 10) <=
          parseInt(A.available, 10)
        );
      };
  ...
  j.addMsg({
    "@attacher.can.modify.alert":
      "\uae30\uc874\uc5d0 \ub4f1\ub85d\ub41c #{title}\uc744(\ub97c) \uc218\uc815\ud560 \uc218 \uc788\ub294 \ud654\uba74\uc73c\ub85c \uc774\ub3d9\ud569\ub2c8\ub2e4.",
    "@attacher.can.modify.confirm":
      "#{title}\uc740(\ub294) \ud558\ub098\ub9cc \ub4f1\ub85d\uc774 \uac00\ub2a5\ud569\ub2c8\ub2e4.\n\ub2e4\uc2dc \uc62c\ub9ac\uc2dc\uba74 \uae30\uc874\uc758 #{title}\uc774(\uac00) \uc0ad\uc81c\ub429\ub2c8\ub2e4. \uacc4\uc18d\ud558\uc2dc\uaca0\uc2b5\ub2c8\uae4c?",
    "@attacher.insert.alert":
      "\uc5d0\ub514\ud130 \uc0c1\ud0dc\uc5d0\uc11c\ub9cc \uc0bd\uc785\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4.",
    "@attacher.capacity.alert":
      "\uc6a9\ub7c9\uc744 \ucd08\uacfc\ud558\uc600\uc2b5\ub2c8\ub2e4.",
    "@attacher.size.alert":
      "\uc6a9\ub7c9\uc744 \ucd08\uacfc\ud558\uc5ec \ub354\uc774\uc0c1 \ub4f1\ub85d\ud560 \uc218 \uc5c6\uc2b5\ub2c8\ub2e4.",
  });
  g.install("sidebar.getAttacher & sidebar.getUploadAdaptor", function (
    w,
    x,
    y
  ) {
  ...
  g.Attacher = g.Class.draft({
    ...
    attachHandler: function (w, e) {
      if (this.checkInsertable()) {
        if (
          this.isCheckSize &&
          !this.entryBox.checkInsertableSize(w.filesize)
        ) {
  ...
  g.install(
    "editor.getEmbedBox & sidebar.getEmbeder & sidebar.getEmbeddedData",
    function (y, z, A, x, w) {
  ...
  g.register("filter > embeder", function (w) {
    var x = w.getEmbedBox();
    var e = w.getDocParser();
    e.registerFilter("filter/embeder", {
      "text@load": function (z) {
        var y = x.datalist;
        y.each(function (A) {
          if (A.loadDataByContent) {
  ...
  g.module("embad entry data", function (y, z, A, x, w) {
    var B = y.getEmbedBox();
    var e = A.embeders;
    y.observeJob(g.Ev.__EDITOR_LOAD_DATA_BEGIN, function (D) {
      B.empty();
      var E = D.content;
      function F(G, H) {
        G = G || [];
  ...
  g.I.WrappingSpanFontTool = g.Mixin.create({
    wrapTextAsStyledSpan: function (z, B, D) {
      ...
      function e(H) {
        ...
        d.iter.forEach(H, function (I) {
          if (
            I.nodeType == 3 &&
            !v.kindOf(I.parentNode, "table,thead,tbody,tr,ul,ol")
          ) {
            G.push(I);
          }
        });
    ...
    findOrCreateDummySpan: function (x, w, e) {
      var y =
        ...
        x.firstChild.nodeType == 3 &&
        x.firstChild.nodeValue == g.__WORD_JOINER;
      if (y) {
        return x;
      } else {
  ...
  g.Tool.Switcher = g.Class.create({
    ...
    oninitialized: function (w) {
      ...
      this.weave.bind(this)(
        new g.Button.Select(
          p.merge(this.buttonCfg, {
            selectedValue: A.data,
            selectedText: A.label,
          })
        ),
        new g.Menu.Select(this.menuCfg),
        z
      );
    },
  });
  ...
  g.Tool.SwitcherToggle = g.Class.create({
    ...
    oninitialized: function () {
      ...
      this.weave.bind(this)(
        new g.Button.Toggle(
          p.merge(this.buttonCfg, { borderClass: "tx-switchtoggle" })
        ),
        i,
        w
      );
  ...
  p.addTool("fontfamily", {
    ...
    options: [
      {
        label:
          TXMSG("@fontfamily.gulim") +
          ' (<span class="tx-txt">\uac00\ub098\ub2e4\ub77c</span>)',
  ...
  g.Tool.FontFamily = g.Class.create({
    ...
    $mixins: [
      ...
      g.I.FontTool,
      g.I.MenuFontTool,
      g.I.WrappingSpanFontTool,
    ],
    beforeOnInitialized: function (x) {
      function w(z) {
        e.usedWebFonts =
          t.msie && z.webfont && z.webfont.use ? z.webfont.options : [];
      ...
      w.generateListItem = function (B) {
        ...
        for (A = 0; A < B.length; A += 1) {
          ...
          C.label = C.label.replace(
            /<span class="tx\-txt">/,
            '<span class="tx-txt" style="font-family:' + C.data + ';">'
          );
  ...
  g.Tool.FontSize = g.Class.create({
    ...
    createFontSizeMap: function (e) {
      ...
      [
        ...
        { title: "36pt", data: "-webkit-xxx-large" },
      ].each(function (x) {
        w[x.data] = x.title;
      });
    },
  ...
  g.Tool.Underline = g.Class.create({
    ...
    $mixins: [
      g.I.FontTool,
      g.I.ButtonFontTool,
      g.I.WrappingDummyFontTool,
      t.gecko ? g.I.Tool.QueryStyle.Gecko : g.I.Tool.QueryStyle.Standard,
    ],
    getRelatedCssPropertyNames: function () {
    ...
    isStyleApplied: function (w) {
      var e = "u";
      return this.queryNodeStyle(
        w,
        this.getCssPropertyName(),
        this.getQueryCommandName(),
        e
      );
    },
  });
  ...
  g.Tool.Indent = g.Class.create({
    ...
    createHandlers: function () {
      ...
      var e = B.connect([
        new B(z.ListItem, w.IndentListItem),
        new B(z.BlockNode, w.IndentBlockNode),
      ]);
      var y = B.connect([
        new B(z.And(z.HeadOfParagraph, z.ListItem), w.IndentListItem),
        new B(z.ChildOfLastTableCell, w.GoToBelowTable),
        new B(z.ChildOfTableCell, w.GoToNextCell),
        new B(z.AlwaysTrue, w.IndentBlockNode),
      ]);
        ...
        y.each(function (z) {
          if (v.kindOf(z, "ul,ol,dl")) {
            ...
            if (v.kindOf(z.parentNode, "table") && v.isText(z)) {
              ...
              if (
                v.kindOf(z.parentNode, "thead,tbody,tfooter") &&
                !v.kindOf(z, "tr")
              ) {
              } else {
                if (v.kindOf(z.parentNode, "tr") && !v.kindOf(z, "th,td")) {
                  ...
                  if (
                    v.kindOf(z.parentNode, "ul,ol,dl") &&
                    !v.kindOf(z, "li,dd,dt")
                  ) {
                  } else {
                    x.push(z);
      ...
      findOrCreateBlockForNode: function (y) {
        if (v.isText(y) || v.kindOf(y, "%inline,img")) {
          ...
          if (x && v.children(x, "%block").length == 0) {
            ...
            x = v.ancestor(
              y,
              "%paragraph,pre,noscript,form,hr,address,fieldset,blockquote"
            );
  ...
  p.addTool("outdent", {
    sync: c,
    status: c,
    hotKey: { shiftKey: u, keyCode: 9 },
  });
  g.Tool.Outdent = g.Class.create({
    $const: { __Identity: "outdent" },
    $extend: g.Tool,
    oninitialized: function (e) {
      this.weave(new g.Button(this.buttonCfg), i, this.handler);
      this.createHandlers();
    ...
    createHandlers: function () {
      ...
      var A = C.connect([
        new C(x.ListItem, w.OutdentListItem),
        new C(x.BlockNode, w.OutdentBlockNode),
      ]);
      var y = C.connect([new C(x.AlwaysTrue, w.Propagate)]);
      var D = C.connect([
        new C(x.ListItem, w.OutdentListItem),
        new C(x.ChildOfFirstTableCell, w.GoToAboveTable),
        new C(x.ChildOfTableCell, w.GoToPreviousCell),
        new C(x.BlockNode, w.OutdentBlockNode),
      ]);
      var B = C.connect([
        new C(x.And(x.HeadOfParagraph, x.OneDepthList), w.Propagate),
        new C(x.And(x.HeadOfParagraph, x.ListItem), w.OutdentListItem),
        new C(
          x.And(x.HeadOfParagraph, x.IndentedBlockNode),
          w.OutdentBlockNode
        ),
  ...
  g.I.AlignExecution = g.Mixin.create({
    ...
    executeAlignTextMode: function (z) {
      ...
      if (x && v.kindOf(x, "button")) {
        ...
        if (w) {
          w.style.margin = this.constructor.__TextModeProps.button["style"][
            "margin"
          ];
        }
      } else {
    ...
    g.Tool.AlignLeft = g.Class.create({
      $const: {
        ...
        __ImageModeProps: {
          paragraph: w,
          image: {
            style: { clear: y, float: e, marginLeft: "", marginRight: "" },
          },
        },
  ...
  (function () {
    ...
    g.Tool.AlignRight = g.Class.create({
      $const: {
        ...
        __ImageModeProps: {
          image: {
            style: { clear: y, float: e, marginLeft: w, marginRight: z },
          },
        },
        __TextModeProps: {
          paragraph: { align: i, style: { textAlign: x } },
  ...
  (function () {
    ...
    g.Tool.AlignFull = g.Class.create({
      $const: {
        ...
        __ImageModeProps: {
          image: {
            style: { clear: y, float: e, marginLeft: z, marginRight: w },
          },
        },
        __TextModeProps: {
          paragraph: { align: i, style: { textAlign: x } },
  ...
  g.Tool.Insertcells = g.Class.create({
    ...
    oninitialized: function (e) {
      ...
      this.weave.bind(this)(
        new g.Button.Select(p.merge(this.buttonCfg, { selectedValue: A })),
        new g.Menu.Select(this.menuCfg),
        x
      );
    },
  ...
  g.Tool.deletecells = g.Class.create({
    ...
    oninitialized: function (e) {
      ...
      this.weave.bind(this)(
        new g.Button.Select(p.merge(this.buttonCfg, { selectedValue: y })),
        new g.Menu.Select(this.menuCfg),
        w
      );
    },
  ...
  g.Tool.Mergecells = g.Class.create({
    ...
    oninitialized: function () {
      ...
      this.weave.bind(this)(
        new g.Button.Select(p.merge(this.buttonCfg, { selectedValue: x })),
        new g.Menu.Select(this.menuCfg),
        e
      );
    },
  ...
  g.Tool.Cellslineheight = g.Class.create({
    ...
    oninitialized: function (w) {
      ...
      e.weave(
        new g.Button.CellslineheightList(e.buttonCfg),
        new g.Menu.Select(e.menuCfg),
        e.handler
      );
    },
  ...
  g.Tool.Cellslinecolor = g.Class.create({
    $const: { __Identity: "cellslinecolor" },
    $extend: g.Tool,
    oninitialized: function () {
      var w = this.canvas;
      var e = this;
  ...
  g.Tool.Cellslinestyle = g.Class.create({
    ...
    oninitialized: function (w) {
      ...
      e.createListStyleMap(w);
      e.weave(
        new g.Button.CellsLineStyledList(e.buttonCfg),
        new g.Menu.Select(e.menuCfg),
        e.handler
      );
    },
  ...
  g.Tool.Cellsoutline = g.Class.create({
    ...
    oninitialized: function (w) {
      ...
      e.createListStyleMap(w);
      e.weave(
        new g.Button.CellsoutlineList(e.buttonCfg),
        new g.Menu.Select(e.menuCfg),
        e.handler
      );
  ...
  g.Tool.Cellslinepreview = g.Class.create({
    ...
    oninitialized: function (w) {
      ...
      this.weave(
        new g.Button.CellslinepreviewList(this.buttonCfg),
        new g.Menu.Select(this.menuCfg),
        this.handler
      );
      this.toolbar.observeJob(g.Ev.__TOOL_CELL_LINE_CHANGE, function (x) {
    ...
    setPreview: function (e) {
      this.button.elText.innerHTML = g.MarkupTemplate.get(
        "cellsline.preview"
      ).evaluate({ value: e, width: 43, height: 14 });
    },
  ...
  g.Tool.TableEditTool = g.Class.create({
    $const: { __Identity: "tableedittool" },
    $extend: g.Tool,
    oninitialized: function (w) {
      var e = this.toolbar;
      var A = e.el;
  ...
  g.Tool.Tabletemplate = g.Class.create({
    ...
    oninitialized: function (w) {
      ...
      this.weave.bind(this)(
        new g.Button(this.buttonCfg),
        new g.Menu.List(this.menuCfg),
        x
      );
    },
  });
  ...
  p.addTool("styledlist", {
    ...
    hotKey: {
      ul: { ctrlKey: u, altKey: u, keyCode: 85 },
      ol: { ctrlKey: u, altKey: u, keyCode: 79 },
    },
  });
  g.Tool.StyledList = g.Class.create({
    $const: { __Identity: "styledlist" },
    $extend: g.Tool,
    oninitialized: function (w) {
      var e = this;
      e.createListStyleMap(w);
      e.weave(
        new g.Button.StyledList(e.buttonCfg),
        new g.Menu.Select(e.menuCfg),
        e.handler,
        e.menuInitHandler.bind(e)
      );
    ...
    _removeBrInListItemForIE: function (x) {
      if (t.msie_docmode >= 11) {
        ...
        if (
          e.isCollapsed() &&
          v.isElement(w) &&
          v.isElement(w.firstChild) &&
          v.isTagName(w.firstChild, "br")
        ) {
  ...
  g.Tool.RichTextBox = g.Class.create({
    ...
    oninitialized: function () {
      ...
      this.weave.bind(this)(
        new g.Button(this.buttonCfg),
        new g.Menu.RichTextbox(this.menuCfg),
        x
      );
    },
  });
  g.MarkupTemplate.add(
    ...
    [
      ...
      '		<a href="javascript:;" class="tx-color-bg-thumb" style="background-color:#{color}"></a>',
      "	</div>",
  ...
  g.Menu.RichTextbox = g.Class.create({
    ...
    ongenerated: function (P) {
        ...
        t.observe(U, "click", function (V) {
          ...
          k.fire(W, {
            span: function () {
              ...
              if (
                W.firstChild &&
                W.firstChild.nodeType == 1 &&
                W.firstChild.tagName.toLowerCase() == "img"
              ) {
      ...
      (function y() {
        ...
        S.appendChild(
          tx.dl(
            { style: { height: "24px" } },
            tx.dt(TXMSG("@richtextbox.border.style")),
            O()
          )
        );
      ...
      var L = function () {
        ...
        D.borderColorInput.style.backgroundColor =
          D.elPreview.style.borderTopColor;
        D.bgColorInput.style.backgroundColor =
          D.elPreview.style.backgroundColor;
      };
      var A = function (S) {
    ...
    generateBorderWidth: function () {
      ...
      var y = tx.a(
        { href: "javascript:;", className: "btn_add" },
      ...
      var e = tx.a(
        { href: "javascript:;", className: "btn_sub" },
  ...
  p.addTool(
    "table",
    { borderStyle: "1px solid #ccc", sync: c, status: u },
    function (w) {
  ...
  g.Tool.Table.TemplateWizard = g.Class.create({
    initialize: function () {
      this.templateList =
        typeof getTableTemplateList == "function"
    ...
    setCellStyle: function (w, e) {
      ...
      Object.extend(
        y,
        e.isFirstRow ? x.firstRow : e.isLastRow ? x.lastRow : {}
      );
  ...
  g.Menu.Table = g.Class.create({
    $const: { MAX_ROW: 99, MAX_COL: 99 },
    $extend: g.Menu,
    ongenerated: function () {
      this.rowSize = 1;
      this.colSize = 1;
      this.elInnerPreview = v.collect(
        this.elMenu,
        "div.tx-menu-inner .tx-menu-preview"
      );
      this.dynamicSizer = this.generateDynamicSizer(this.elInnerPreview);
      this.elInnerRowCol = v.collect(
        this.elMenu,
        "div.tx-menu-inner .tx-menu-rowcol"
      );
      this.generateTextSizer(this.elInnerRowCol);
      this.elButtonArea = v.collect(
        this.elMenu,
        "div.tx-menu-inner .tx-menu-enter"
      );
    ...
    generateTextSizer: function (w) {
      ...
      t.observe(x, "blur", function () {
        x.value = e.colSize = y.getValidValue(
          x.value,
          e.colSize,
          g.Menu.Table.MAX_COL
        );
      });
      t.observe(
        v.collect(w, "div.tx-col-field a.tx-btn-add"),
        "click",
        function (A) {
      ...
      t.observe(
        v.collect(w, "div.tx-col-field a.tx-btn-sub"),
        "click",
        function (A) {
          x.value = e.colSize = y.calculate(
            e.colSize,
            g.Menu.Table.MAX_COL,
            -1
          );
      ...
      t.observe(z, "blur", function () {
        z.value = e.rowSize = y.getValidValue(
          z.value,
          e.rowSize,
          g.Menu.Table.MAX_ROW
        );
      });
      t.observe(
        v.collect(w, "div.tx-row-field a.tx-btn-add"),
        "click",
        function (A) {
      ...
      t.observe(
        v.collect(w, "div.tx-row-field a.tx-btn-sub"),
        "click",
        function (A) {
          z.value = e.rowSize = y.calculate(
            e.rowSize,
            g.Menu.Table.MAX_ROW,
            -1
          );
    ...
    generateButtonArea: function (x) {
      ...
      var y = tx.div();
      var z = tx.a(
        { href: "javascript:;", className: "tx-btn-confirm" },
        "\ud655\uc778"
      );
      var w = tx.a(
        { href: "javascript:;", className: "tx-btn-cancel" },
        "\ucde8\uc18c"
      );
  ...
  p.addTool("removeformat", {
    ...
    sync: u,
    status: c,
    hotKey: { ctrlKey: u, shiftKey: u, keyCode: 88 },
  });
  ...
  g.module("initialize removeformat without toolbar button", function (
    y,
    z,
    A,
    w
    ...
    "horizontalrule",
    {
      ...
      options: [
        ...
        },
        {
          ...
          html:
            '<div style="background: url(#decopath/horizontalrule/line03.gif?v=2) repeat-x scroll left;  width: 99%; height: 15px"><hr style="border: black 0 none; left: -9999px; position: relative; top: -9999px"></div>',
        },
        {
          data: "tx-hr-image-2",
          image: "#iconpath/horizontalrule/line05.gif?v=2",
          html:
            '<div style="background: url(#decopath/horizontalrule/line05.gif?v=2) repeat-x scroll left;  width: 99%; height: 15px"><hr style="border: black 0 none; left: -9999px; position: relative; top: -9999px"></div>',
        },
        {
          data: "tx-hr-image-3",
          image: "#iconpath/horizontalrule/line06.gif?v=2",
          html:
            '<div style="background: url(#decopath/horizontalrule/line06.gif?v=2) repeat-x scroll left;  width: 99%; height: 15px"><hr style="border: black 0 none; left: -9999px; position: relative; top: -9999px"></div>',
        },
        {
          data: "tx-hr-image-4",
          image: "#iconpath/horizontalrule/line07.gif?v=2",
          html:
            '<div style="background: url(#decopath/horizontalrule/line08.gif?v=2) repeat-x scroll left;  width: 99%; height: 15px"><hr style="border: black 0 none; left: -9999px; position: relative; top: -9999px"></div>',
        },
      ],
    },
    function (e) {
  ...
  g.Tool.Dictionary = g.Class.create({
    ...
    oninitialized: function (e) {
      ...
      var w = function () {
        ...
        var y =
          A.length > 0 ? "http://engdic.daum.net/dicen/small_search.do" : e.url;
        var z = h.open(
          y + "?q=" + A,
          "dicWin",
          "width=410,height=550,scrollbars=yes"
        );
        z.focus();
      };
  ...
  (function () {
    ...
    g.Tool.Background = g.Class.create({
      $const: { __Identity: "background" },
      $extend: g.Tool,
      oninitialized: function () {
        this.weave(
          new g.Button(this.buttonCfg),
          new g.Menu.ColorPallete(this.menuCfg),
          this.handler
        );
      },
      handler: function (x) {
        ...
        if (x === null) {
          y.addStyle({
            backgroundColor: y.getConfig().styles
              ? y.getConfig().styles.backgroundColor || ""
              : "",
            backgroundImage: y.getConfig().styles
              ? y.getConfig().styles.backgroundImage || ""
              : "",
          });
          e = "";
    ...
    g.install(
      "canvas.getBgColor & canvas.setBgColor & editor.getContentWithBg",
      function (z, A, B, y, x) {
        ...
        y.initContent = function (D) {
          if (D.search(/<table[^>]*txc-wrapper[^>]*>/i) > -1) {
            var C;
            D = D.replace(
              /<table[^>]*txc-wrapper[^>]*><tr><td([^>]*)>([\s\S]*?)<\/td><\/tr><\/table>/i,
              function (G, E, F) {
  ...
  g.module("add drop-down menu button if extra buttons exist.", function (
    w,
    x,
    y,
    e
    ...
    e.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
      ...
      z.each(function (B) {
        ...
        x.makeWidget(
          new g.Button({ el: B, sync: c, status: u }),
          new g.Menu({ el: A }),
          function () {}
        );
      });
  ...
  g.Attacher.Image = g.Class.create({
    ...
    getDataForEntry: function (x) {
      ...
      x.thumburl =
        x.thumburl || x.imageurl.replace(/\/image\//gm, "/P150x100/");
      if (!x.dispElId) {
        x.dispElId = g.Util.getDispElId();
      }
      var e = x.tmpSeq
        ? this.entryBox.syncSeq(x.tmpSeq)
        : this.entryBox.newSeq();
  ...
  g.Attachment.Image = g.Class.create({
    ...
    getRegLoad: function (e) {
      return new RegExp(
        '<(?:img|IMG)[^>]*src="?' + e.imageurl.getRegExp() + '"?[^>]*/?>',
        "gim"
      );
    },
  ...
  g.Attacher.File = g.Class.create({
    ...
    getDataForEntry: function (z) {
      ...
      var e = z.tmpSeq
        ? this.entryBox.syncSeq(z.tmpSeq)
        : this.entryBox.newSeq();
  ...
  g.Attachment.File = g.Class.create({
    ...
    getDispHtml: function (e) {
      return (
        '<button id="' +
        e.dispElId +
        '" class="txc-file"><img class="tx-unresizable" src="' +
        e.prevurl +
        '" ld="' +
        e.attachurl +
        '"/> ' +
  ...
  (function () {
    g.Embeder.Media = g.Class.create({
      ...
      generateHTMLForFlash: function (F, G) {
        return (
          ...
          "\" quality='high' " +
          this.getAllowScriptAccess(F) +
          " type='application/x-shockwave-flash' allowfullscreen='true' pluginspage='http://www.macromedia.com/go/getflashplayer' wmode='transparent' width='" +
          G.width +
          "' height='" +
          G.height +
          "'></embed>"
      ...
      generateHTMLForMoviePlayer: function (F, G) {
        return (
          '<embed src="' +
          F +
          '" type="application/x-mplayer2" pluginspage="http://www.microsoft.com/Windows/MediaPlayer/" width=\'' +
          G.width +
          "' height='" +
          G.height +
          "'></embed>"
      ...
      generateHTMLForQuicktime: function (F, G) {
        return (
          '<embed src="' +
          F +
          '" type="video/quicktime" pluginspage="http://www.apple.com/quicktime/download/indext.html" width=\'' +
          G.width +
          "' height='" +
          G.height +
          "'></embed>"
      ...
      generateHTMLIfIframeSource: function (H, I) {
        ...
        if (G) {
          return (
            '<iframe src="http://videofarm.daum.net/controller/video/viewer/Video.html?play_loc=undefined&vid=' +
            G +
            "\" width='" +
            I.width +
            "' height='" +
    ...
    function z(H, G) {
      ...
      F = F.replace(/(<embed)([^>]*)(><\/embed>|\/>)/gi, function (L, M, I, J) {
        ...
        I = I.replace(/\s+allowNetworking=["']?[\w]*["']?/i, "").concat(
    ...
    function B(L) {
      if (t.msie) {
        if (t.msie_ver < 10) {
          L = L.replace(
            /<iframe[^>]*src=("|'|)https?:\/\/www\.youtube\.com\/embed\/(\w+)\1[^>]*><\/iframe>/i,
            function (S, R, Q) {
              var P, T, O;
              P = S.match(/\swidth=['"]?(\d+)/);
              T = (P && P[1]) || "560";
              ...
              return (
                ...
                Q +
                '?version=3&amp;hl=ko_KR" /><param name="allowFullScreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="wmode" value="transparent" /><embed src="https://www.youtube.com/v/' +
                Q +
                '?version=3&amp;hl=ko_KR" type="application/x-shockwave-flash" width="' +
                T +
                '" height="' +
                O +
        ...
        if (
          /<object/.test(L) &&
          /<embed[^>]*type=['"]application\/x-shockwave-flash['"][^>]*>/i.test(
            L
          ) &&
          !/<object[^>]*type=['"]application\/x-shockwave-flash['"][^>]*>/i.test(
            L
          )
        ) {
          var J = L.indexOf(">");
        ...
        var H = L;
        var F = new RegExp(
          "<(?:script)[^>]*>[\\S\\s]*?(<(?:embed|EMBED)[^>]*src=[^>]*>)[\\S\\s]*?</(?:script)>",
          "gim"
        );
        while ((K = F.exec(H)) != i) {
          I = K[0];
        ...
        var N = new RegExp(
          "<(?:object|OBJECT)[^>]*>[\\S\\s]*?(<(?:embed|EMBED)[^>]*src=[^>]*>)[\\S\\s]*?</(?:object|OBJECT)>",
          "gim"
        );
        while ((K = N.exec(H)) != i) {
          I = K[0];
    ...
    function E(H, P) {
      ...
      var M = G.height.isPercent() ? G.height : (G.height || " ").parsePx();
      if (parseInt(L, 10) === 0 || parseInt(M, 10) === 0) {
        var Q = y(K);
        L = Q.width;
        M = Q.height;
      }
      ...
      return (
        ...
        '" height="' +
        M +
        '" border="0" class="tx-entry-embed txc-media' +
        F.className +
        '" ld="' +
    ...
    function y(G) {
      ...
      if (G.indexOf("api.bloggernews.media.daum.net/static/recombox1") > -1) {
        ...
        if (G.indexOf("flvs.daum.net/flvPlayer") > -1) {
          ...
          if (
            G.indexOf("youtube") != -1 ||
            G.indexOf("youtu.be") != -1 ||
            G.indexOf("tvpot.daum.net") != -1
          ) {
            var H = p.get("size");
  ...
  j.addMsg({
    "@canvas.unload.message":
      "\uc791\uc131\ud558\uc2e0 \ub0b4\uc6a9\uc774 \uc800\uc7a5\ub418\uc9c0 \uc54a\uc558\uc2b5\ub2c8\ub2e4. \ud398\uc774\uc9c0\ub97c \ub5a0\ub098\uc2dc\uaca0\uc2b5\ub2c8\uae4c?",
    "@canvas.unload.message.at.modify":
      "\uc791\uc131\ud558\uc2e0 \ub0b4\uc6a9\uc774 \uc800\uc7a5\ub418\uc9c0 \uc54a\uc558\uc2b5\ub2c8\ub2e4. \ud398\uc774\uc9c0\ub97c \ub5a0\ub098\uc2dc\uaca0\uc2b5\ub2c8\uae4c?",
  });
  g.install(
    "editor.isDisableUnloadHandler & editor.setDisableUnloadHandler",
    function (e) {
      var w = u;
  ...
  g.module(
    "Register an eventhandler in order to change align icons upon toolbar when user click a specific image or not.",
    function (y, A, B, x) {
      ...
      var z = function (D) {
        ...
        E(
          ...
          D,
          D == "image"
            ? TXMSG("@align.image.align.left")
            : TXMSG("@align.text.align.left")
        );
        E(
          w[1],
          D,
          D == "image"
            ? TXMSG("@align.image.align.center")
            : TXMSG("@align.text.align.center")
        );
        E(
          w[2],
          D,
          D == "image"
            ? TXMSG("@align.image.align.right")
            : TXMSG("@align.text.align.right")
        );
        E(
          w[3],
          D,
          D == "image"
            ? TXMSG("@align.image.align.full")
            : TXMSG("@align.text.align.full")
        );
      };
      x.observeElement(
        [{ tag: "body" }, { tag: "table" }, { tag: "hr" }],
        function () {
          z("text");
        }
      );
  ...
  g.module("make padding area inside Canvas with editor width", function (
    A,
    K,
    M,
    y
    ...
    function N(Y) {
      ...
      if (z) {
        ab.mleft = Math.max(Math.ceil(w()), 0);
        ab.mright = Math.max(Math.floor(w()), 0);
        return {
          width: P.toPx(),
          ...
          marginLeft: ab.mleft.toPx(),
          marginRight: ab.mright.toPx(),
        };
      } else {
        return {
          paddingTop: ab.top.toPx(),
  ...
  g.module(
    "Register an eventhandler in order to resize block and edit search results & some images in wysiwig panel.",
    function (y, z, A, w) {
      if (t.msie_nonstd) {
        var e = function (B) {
  ...
  g.module("in order to save history for image resizing on IE", function (
    y,
    z,
    A,
    w
  ...
  g.module(
    "Add layer to display notice message on editor area before editing",
    function (x, y, z, w, e) {
      if (e.initializedMessage) {
        w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
          var F = e.initializedId;
          var E = tx.div(
            { id: "tx-canvas-notice" + F, className: "tx-canvas-notice" },
  ...
  g.MarkupTemplate.add(
    ...
    '<div class="tx-table-col-resize-dragger" style="position:absolute; overflow:hidden; top: 0; left: 0; width: 3px; height: 100%; cursor:col-resize;"></div>'
  );
  g.MarkupTemplate.add(
    "table.row.resize.dragger",
    '<div class="tx-table-row-resize-dragger" style="position:absolute; overflow:hidden; top: 0; left: 0; width: 100%; height: 3px; cursor:row-resize;"></div>'
  );
  j.addMsg({
    "@table.noselect.alert":
      "\ud14c\uc774\ube14\uc744 \uc120\ud0dd\ud558\uc2e0 \ud6c4 \uc0ac\uc6a9\uac00\ub2a5\ud569\ub2c8\ub2e4.",
  });
  g.Table = {};
    ...
    x.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
      ...
      F.table = {
        ...
        setTemplateStyle: function (P, O) {
          if (P) {
            var N = this;
            D.getTemplate(O, function (Q) {
              Q.apply(P);
              N._applyTemplateOutline(P, Q.templateData);
              H.reset();
            });
          } else {
            K();
        ...
        _applyTemplateOutline: function (U, N) {
          var V = N;
          var W = this;
          var P = {
            top: this._parseBorderStyle(V.firstRow.borderTop),
            right: this._parseBorderStyle(
              V.lastCol.borderRight || V.common.borderRight
            ),
            bottom: this._parseBorderStyle(
              V.lastRow.borderBottom || V.common.borderBottom
            ),
            left: this._parseBorderStyle(V.firstCol.borderLeft),
          };
          var S = new g.Tool.Table.TableCellMatrixer(U);
          var O = S.getTdMatrix();
          var T = S.getRowSize();
          var Q = S.getColSize();
          if (O && O.length) {
            H.selectByTd(O[0][0], O[T - 1][Q - 1]);
            J.setTableSelect(H);
            var R = ["top", "right", "bottom", "left"];
            R.each(function (X) {
              J.setBorderRange(X);
              J.changeBorderColor(W.getTdArr(), P[X]["color"]);
              J.changeBorderHeight(W.getTdArr(), P[X]["height"]);
              J.changeBorderType(W.getTdArr(), P[X]["type"]);
            });
          }
        },
        _parseBorderStyle: function (N) {
          N = N.trim().toLowerCase();
          if (N === "none") {
            return { height: "none", type: "solid", color: "transparent" };
          } else {
            var O = N.split(" ");
            if (O.length != 3) {
              O = ["1px", "solid", "#000"];
            }
            return { height: O[0].parsePx() || 1, type: O[1], color: O[2] };
          }
        },
      };
  ...
  g.Table.Selector = g.Class.create({
    ...
    applyCss: function () {
      ...
      t.applyCSSText(
        e,
        "." + this.SELECTED_CLASS_NAME + this.SELECTED_CSS_TEXT
      );
    },
    observeEvent: function () {
      var w;
      w = this;
      this.canvas.observeJob(g.Ev.__CANVAS_PANEL_MOUSEDOWN, function (B) {
        var A;
        A = t.element(B);
        w.onmousedown(A);
      });
      t.observe(this.htmlBody, "mousemove", function (B) {
        var A;
        A = t.element(B);
        w.onmousemove(A);
      });
      this.canvas.observeJob(g.Ev.__CANVAS_PANEL_MOUSEUP, function (A) {
        w.onmouseup();
      });
      var z;
      try {
      ...
      t.observe(z, "mouseup", function (A) {
        w.onmouseup();
      });
      this.canvas.observeJob(g.Ev.__CANVAS_PANEL_KEYDOWN, function (A) {
        if (w.isDragging) {
          t.stop(A);
          w.reset();
        } else {
          w.onkeydown(A.ctrlKey, A.keyCode);
        }
      });
  ...
  j.addMsg({
    "@table.merge.confirm":
      "\uc140\uc744 \ubcd1\ud569\ud558\uba74 \ub9e8 \uc704\ucabd \uc140\uc5d0 \uc788\ub294 \uac12\ub9cc \ub0a8\uace0 \ub098\uba38\uc9c0 \uac12\uc740 \uc783\uac8c \ub429\ub2c8\ub2e4.",
    "@table.merge.more.select.cells":
      "\ub450 \uac1c \uc774\uc0c1\uc758 \uc140\uc744 \uc120\ud0dd\ud574\uc8fc\uc138\uc694.",
  });
  ...
  g.Table.Insert = g.Class.create({
    COL_DIRECTION: { LEFT: "left", RIGHT: "right" },
    initialize: function (w) {
      var e;
      e = w.getCanvas();
      this.wysiwygPanel = e.getPanel(g.Canvas.__WYSIWYG_MODE);
  ...
  (function () {
    g.Table.TemplateLoader = g.Class.create({
      ...
      loadTemplate: function (x) {
        var w =
          this.getJSBasePath() + "trex/modules/table/async/template_data.js";
        if (EditorJSLoader.getOption("environment") == "development") {
    ...
    var e = g.Class.create({
      ...
      setCellStyle: function (x, w) {
        ...
        Object.extend(
          z,
          w.isFirstRow ? y.firstRow : w.isLastRow ? y.lastRow : {}
        );
  ...
  g.module("page up & down", function (x, y, z, w, e) {
    w.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function (C) {
      ...
      function A() {
        var E =
          (h.pageYOffset || b.documentElement.scrollTop) -
          (b.documentElement.clientTop || 0);
        var D =
          (h.pageXOffset || b.documentElement.scrollLeft) -
  ...
  p.add(
    {
      canvas: {
        exitEditor: {
          desc:
            "\uc5d0\ub514\ud130 \uc601\uc5ed : \uc5d0\ub514\ud130 \uc601\uc5ed\uc5d0\uc11c \ube60\uc838 \ub098\uc624\uc2dc\ub824\uba74 Shift+ESC\ud0a4\ub97c \ub204\ub974\uc138\uc694",
          hotKey: { shiftKey: true, keyCode: 27 },
          nextElement: null,
        },
      },
    },
  ...
  g.module("exit Editor", function (B, E, e, x, A) {
    ...
    function w(F) {
      return !(
        t.getStyle(F, "display") == "none" ||
        t.getStyle(F, "visibility") == "hidden" ||
        (F.tagName.toLowerCase() === "input" && F.type == "hidden") ||
        (F.tagName.toLowerCase() === "a" && (F.href || "").trim() == "") ||
        F.offsetLeft <= 0
      );
    }
    function y(K) {
